...
weight: 6
draft: false
editURL: "https://github.com/darwoot/copaah_hugo/edit/main/content/docs/journeenationale2022/index.fr.md"
...
### 1. Cas complexes : définitions et enjeux

**Pr Mélina Fatseas** (Bordeaux) a défini les **cas complexes** comme des situations cliniques caractérisées par :
  - Une **intrication de problématiques multiples** (psychiatriques, somatiques, sociales, judiciaires).
  - Une **évolution imprévisible** et des parcours de soins aléatoires.
  - La nécessité d’une **évaluation globale** et d’une **coordination renforcée** entre les professionnels.

Les outils d’évaluation, comme l’**Addiction Severity Index**, permettent d’appréhender la sévérité et la multidimensionalité des troubles.

### 2. Clinique de la complexité : études de cas
...
**Dr Patrick Daimé et Dr Jacqueline Kerjean** (Addictions France) ont souligné l’importance du **secteur médico-social** dans la prise en charge des cas complexes :

- **Accompagnement dans la durée** et **proximité** avec les patients.
- **Coordination avec les acteurs sanitaires** pour éviter les ruptures de parcours.
- **Dispositifs d’Appui à la Coordination (DAC)** comme leviers pour une meilleure articulation des soins.
...
- **Financement et cahiers des charges** pour les centres experts, avec une mise en œuvre progressive à partir de 2023.

### 5. Ateliers pratiques

Trois ateliers ont permis d’approfondir des thématiques clés :
- **Atelier 1** : **SMRA et parcours de soins** (Géraldine Austruy, Michel Morin, Sylvie Wackenheim).
- **Atelier 2** : **HDJA et parcours de soins** (Dr Gonzague De Larocque-Latour, Dr Romain Gomet).
- **Atelier 3** : **Consultations complexes et coordination des soins** (Dr Françoise Albertini, Dr Michaël Bazin, Dr Camille Rougerie-Baila).
...
- **Développement des outils d’évaluation** pour mieux appréhender la complexité des situations.
- **Renforcement des liens entre les secteurs** (sanitaire, médico-social, social) pour une prise en charge globale et coordonnée.
- **Formation des professionnels** à la gestion des cas complexes et à l’utilisation des dispositifs de coordination.
